...
from mlProject.utils.advanced_preprocessing import prase_processor_name,extract_cores_threads,get_gpu_type
...
class DataValidation:
    ...
    def validate_all_columns(self)-> bool:
        try:
            ...
            all_schema = self.config.all_schema_keys()
    ...
    def advanced_processing(self)-> bool:
        try:
            ...
            for processor in processors:
                value = prase_processor_name(processor)
                new.append(value)
            ...
            # adding new columsn (future engineering)
            ...
            # handling ROM_type
            data.update(data["ROM_type"].apply(lambda x: 1 if "SSD" else 0))
            ...
            logger.info("data file saved to give path")
            return True
        except Exception as e:
            raise e
