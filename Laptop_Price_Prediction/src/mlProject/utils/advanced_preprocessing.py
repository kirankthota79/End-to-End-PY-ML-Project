...
def parse_processor_name(processor_name):
    # Define regular expression for extracting information
    regexes = [
    ...
    # Match the regular expression against the processor name
...
def get_gpu_type(gpu_name):
    # Define regulare Expressions for extracting GPU type information
    regexes = [
...
def extract_core_threads(cpu_name):
